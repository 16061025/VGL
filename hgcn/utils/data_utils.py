...
def mask_edges(adj, val_prop, test_prop, seed):
    ...
    return adj_train, torch.LongTensor(train_edges.tolist()), torch.LongTensor(train_edges_false.tolist()), torch.LongTensor(val_edges.tolist()), \
           torch.LongTensor(val_edges_false.tolist()), torch.LongTensor(test_edges.tolist()), torch.LongTensor(test_edges_false.tolist())
